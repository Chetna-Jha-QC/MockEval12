...
document.getElementById("addQusetionForm").addEventListener("submit", async (e) => {
    e.preventDefault();

    const questionData ={
        statement: document.getElementById("addquestionForm").addEventListener("submit", async (e) => {
